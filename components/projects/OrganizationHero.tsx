...
export function OrganizationHero({ onViewProjectsClick }: OrganizationHeroProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative overflow-hidden rounded-3xl bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-white mb-12 shadow-xl border border-slate-200 dark:border-slate-800 opacity-0"
    >
